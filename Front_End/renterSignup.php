...
<head>
    <meta charset="utf-8">
    <title>Renter Sign Up</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <style>
        body {
            background-color: #1c1c1e;
            background-image: url('images/renterSignup.jpg'); /* Replace with your image */
...
<body>
    ...
    <div class="full-container">
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="#">Renter Sign Up</a></li>
                </ul>
            </div>
        </nav>
        ...
        <div class="content">
            <div class="form_">
                <h4>Renter Additional Details</h4>

                <form action="renterReg.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="equipment_details" name="equipment_details" placeholder="Describe the equipment you offer for rent" rows="3" required></textarea>
                    </div>
